...
const AboutSection = () => {
  return (
    <section className="mx-auto mt-6 max-w-3xl rounded-xl bg-white px-6 md:px-12 py-8 md:py-10 shadow-sm">
      <h1 className="text-lg md:text-xl font-bold">About this project</h1>
